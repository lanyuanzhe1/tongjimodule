...
def fetch_energy_consumption_data():
    ...
    indicator_ids = [
        "2f3342ede361404a8300af41b8248624",
        "55c675f673bc435d83059b73677b79d1",
        "1adf8f9a0e484c1d999c3291b62721eb",
        "670d2fc393c64cf5809d27535d4c0bdf",
        "ded11e08b23b4019b826094a015ceb2b",
        "cea355a03c66411ab3a38f25079515c2",
        "033ca8e631434175a43e30f2677d2e0d",
        "801a3a26ad5648ba91eadb9a0377c4d4",
        "808cac47e5824d1f91af38c0962a336b"
    ]

    results = []
    print(f"开始抓取省份主要能源产品消费量数据，涵盖 {len(provinces)} 个省市...")

    for prov_code, prov_name in provinces.items():
        print(f"正在获取 [{prov_name}] 数据...")

        payload = {
            "cid": "ccc1ef64e4a0485f840cd5f6fa192097",
    ...
    output_path = os.path.join(os.path.dirname(__file__), "分省主要能源产品消费量_多年期_原始抓取.csv")

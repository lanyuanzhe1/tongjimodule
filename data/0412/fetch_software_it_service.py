...
def fetch_software_it_service_data():
    # 国家统计局数据接口
    ...
    indicator_ids = [
        "022e11c857ce40d3a827be6ab3263449",
        "6f18e7f5e82d4090ae591baa9178584c",
        "d045b17918424b3d8376fa403e8ca75a",
        "260e849c86584b208571ad8251260f2c",
        "d636b74cd57f4f70b99c61fa5796f310",
        "871ceb0b9a0045e18986b0ff48350836"
    ]

    results = []
    print(f"开始抓取省份软件和信息技术服务业主要经济指标，涵盖 {len(provinces)} 个省市...")

    for prov_code, prov_name in provinces.items():
        print(f"正在获取 [{prov_name}] 数据...")

        payload = {
            "cid": "f78cb6a5c77747a6abc401b615245ef1",
    ...
    output_path = os.path.join(os.path.dirname(__file__), "分省软件和信息技术服务业主要经济指标_多年期_原始抓取.csv")
...
if __name__ == "__main__":
    ...
    fetch_software_it_service_data()

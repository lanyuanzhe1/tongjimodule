...
def clean_software_it_service_json():
    input_file = os.path.join(os.path.dirname(__file__), "分省软件和信息技术服务业主要经济指标_多年期_原始抓取.csv")
    ...
    output_file = os.path.join(os.path.dirname(__file__), "分省软件和信息技术服务业主要经济指标_多年期_面板数据.csv")
...
if __name__ == "__main__":
    clean_software_it_service_json()

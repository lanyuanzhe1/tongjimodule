...
def clean_enterprise_informatization_ecommerce_json():
    input_file = os.path.join(os.path.dirname(__file__), "分省企业信息化及电子商务情况_多年期_原始抓取.csv")
    ...
    output_file = os.path.join(os.path.dirname(__file__), "分省企业信息化及电子商务情况_多年期_面板数据.csv")
...
if __name__ == "__main__":
    clean_enterprise_informatization_ecommerce_json()

...
def clean_internet_json():
    # 1. 读取刚刚抓取到的原始数据
    input_file = os.path.join(os.path.dirname(__file__), "分省互联网主要指标_多年期_原始抓取.csv")
    ...
    # 4. 导出
    output_file = os.path.join(os.path.dirname(__file__), "分省互联网主要指标_多年期_面板数据.csv")

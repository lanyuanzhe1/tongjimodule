...
def clean_energy_consumption_json():
    input_file = os.path.join(os.path.dirname(__file__), "分省主要能源产品消费量_多年期_原始抓取.csv")
    ...
    output_file = os.path.join(os.path.dirname(__file__), "分省主要能源产品消费量_多年期_面板数据.csv")

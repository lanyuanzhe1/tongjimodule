...
def fetch_enterprise_informatization_ecommerce_data():
    # 国家统计局数据接口
    ...
    indicator_ids = [
        "d0e5b0c43031452b8347f19137d759ba",
        "e7444ed0273948dc8833c040548291fa",
        "9a24dfc9b05041b3b7fc55c1b74ee1d9",
        "29f2eba1554546ef8d913dcdf8a5c044",
        "e0296541641140aabe06f512389d9c40",
        "e2dffc835af64f64adec93833dab76d1",
        "eda3cbd33f6c4511aac6571b92b42d00",
        "2dd169f72138479eadf6f3d18d48f1ee",
        "575195cb536d4d2a98cbc7736579cb44"
    ]

    results = []
    print(f"开始抓取省份企业信息化及电子商务情况数据，涵盖 {len(provinces)} 个省市...")
    ...
    output_path = os.path.join(os.path.dirname(__file__), "分省企业信息化及电子商务情况_多年期_原始抓取.csv")
...
if __name__ == "__main__":
    ...
    fetch_enterprise_informatization_ecommerce_data()

...
def clean_population_json():
    # 1. 读取刚刚抓取到的原始数据
    input_file = os.path.join(os.path.dirname(__file__), "分省人口_多年期_原始抓取.csv")
        ...
        try:
            ...
            for yd in year_data_list:
                ...
                for ind in indicators:
                    # 获取指标名称并清理多余的空格（例如把 "年末常住人口 (万人) " 洗整齐）
    ...
    # 清理掉全为空值的列（如 2025年如果国家还没公布可能全为空）
    ...
    # 4. 导出
    output_file = os.path.join(os.path.dirname(__file__), "分省人口_多年期_面板数据.csv")
